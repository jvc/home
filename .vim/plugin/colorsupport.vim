...
function! s:hl_dflt_light()
    ...
    Highlight MoreMsg       gui=bold        guifg=#2e8b57  guibg=none
    Highlight ModeMsg       gui=bold        guifg=none      guibg=none
    Highlight LineNr        gui=none        guifg=Brown     guibg=none
    Highlight Question      gui=bold        guifg=#2e8b57  guibg=none
    ...
    Highlight CursorColumn  gui=none        guifg=none      guibg=#e4e4e4
    Highlight CursorLine    gui=none        guifg=none      guibg=#e4e4e4
